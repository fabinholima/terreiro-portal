...
router.get('/pagina/:slug',[PagesController,'custom']).as('pages.custom')
...
router.group(()=>{
  ...
  router.get('/admin/menus',[MenusController,'index']).as('admin.menus.index').use(middleware.adminOnly())
  router.post('/admin/menus/items',[MenusController,'storeItem']).as('admin.menus.items.store').use(middleware.adminOnly())
  router.post('/admin/menus/items/:id',[MenusController,'updateItem']).as('admin.menus.items.update').use(middleware.adminOnly())
  router.post('/admin/menus/items/:id/delete',[MenusController,'destroyItem']).as('admin.menus.items.destroy').use(middleware.adminOnly())
